...
/**
 * @author rupak
 * FoodTruckFinder fetches json data from https://data.sfgov.org/resource/jjew-r69b.json and prints Name and location on console
 * 
 * Example
 * NAME       				 ADDRESS
 * ----       				 -------
 * La Jefa                531 BAY SHORE BLVD
 * Munch A Bunch          1850 MISSION ST  
 */
	...
	public static void main(String[] args) {
		...
		try {
			trucks = Unirest
					...
					.header("X-App-Token", xAppTokenkey)
